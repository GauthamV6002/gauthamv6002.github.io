interface ProjectData {
  ...
  iconSVG: string;
  projectLink: string | false;
  projectGithub: string;
}

const projectArchiveData: ProjectData[] = [
  // IMPORTANT - all svg icons must have class "lg:size-8 size-5" for styling to work
  {
    projectTitle: "CTRL Hacks",
    projectDescription:
      "Co-founded an independent hackathon for highschool students. I designed the three.js-powered website, and helped deal with with organizational logistics, fundraising, and outreach.",
    iconSVG:
      '<img class="lg:size-8 size-5" src="public/ctrl_hacks_logo.svg" alt="CTRL Hacks Logo" />',
  ...
  },
  {
    ...
    projectDescription:
      "A self-watering plant-pod powered by an Arduino and a gamified frontend, made in 24 hours. Won 1st Place at Code the Change YYC.",
    iconSVG:
      '<svg class="lg:size-8 size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20.998 3V5C20.998 14.6274 15.6255 19 8.99805 19L5.24077 18.9999C5.0786 19.912 4.99805 20.907 4.99805 22H2.99805C2.99805 20.6373 3.11376 19.3997 3.34381 18.2682C3.1133 16.9741 2.99805 15.2176 2.99805 13C2.99805 7.47715 7.4752 3 12.998 3C14.998 3 16.998 4 20.998 3ZM12.998 5C8.57977 5 4.99805 8.58172 4.99805 13C4.99805 13.3624 5.00125 13.7111 5.00759 14.0459C6.26198 12.0684 8.09902 10.5048 10.5019 9.13176L11.4942 10.8682C8.6393 12.4996 6.74554 14.3535 5.77329 16.9998L8.99805 17C15.0132 17 18.8692 13.0269 18.9949 5.38766C17.6229 5.52113 16.3481 5.436 14.7754 5.20009C13.6243 5.02742 13.3988 5 12.998 5Z"></path></svg>',
    projectLink:
      "https://devpost.com/software/seedpod-empowering-individual-agriculture",
    projectGithub: "https://github.com/ericli3690/hack-the-change",
  },
  {
    projectTitle: "RubbleRecon",
    projectDescription:
      "A prototype inexpensive rover setup for low-cost automated reconnaissance in disaster situations. Won 3rd Place at STEMist Hacks II.",
    iconSVG:
      '<svg class="lg:size-8 size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" /></svg>',
  ...
  },
  {
    ...
    projectDescription:
      "A Visual Path-to Code Editor that helps VEX Robotics teams visually plan out autonomous routes for VRC Over Under. Saw usage by 40+ teams at my High School.",
    iconSVG:
      '<svg class="lg:size-8 size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12c0-1.232-.046-2.453-.138-3.662a4.006 4.006 0 0 0-3.7-3.7 48.678 48.678 0 0 0-7.324 0 4.006 4.006 0 0 0-3.7 3.7c-.017.22-.032.441-.046.662M19.5 12l3-3m-3 3-3-3m-12 3c0 1.232.046 2.453.138 3.662a4.006 4.006 0 0 0 3.7 3.7 48.656 48.656 0 0 0 7.324 0 4.006 4.006 0 0 0 3.7-3.7c.017-.22.032-.441.046-.662M4.5 12l3 3m-3-3-3 3" /></svg>',
  ...
  },
  {
    ...
    projectDescription:
      "A discord bot made to auto-moderate a server of 200+ IB students. Also had an wildly over-engineered virtual snowball-throwing system, just for fun :)",
    iconSVG:
      '<svg class="lg:size-8 size-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M19.3034 5.33716C17.9344 4.71103 16.4805 4.2547 14.9629 4C14.7719 4.32899 14.5596 4.77471 14.411 5.12492C12.7969 4.89144 11.1944 4.89144 9.60255 5.12492C9.45397 4.77471 9.2311 4.32899 9.05068 4C7.52251 4.2547 6.06861 4.71103 4.70915 5.33716C1.96053 9.39111 1.21766 13.3495 1.5891 17.2549C3.41443 18.5815 5.17612 19.388 6.90701 19.9187C7.33151 19.3456 7.71356 18.73 8.04255 18.0827C7.41641 17.8492 6.82211 17.5627 6.24904 17.2231C6.39762 17.117 6.5462 17.0003 6.68416 16.8835C10.1438 18.4648 13.8911 18.4648 17.3082 16.8835C17.4568 17.0003 17.5948 17.117 17.7434 17.2231C17.1703 17.5627 16.576 17.8492 15.9499 18.0827C16.2789 18.73 16.6609 19.3456 17.0854 19.9187C18.8152 19.388 20.5875 18.5815 22.4033 17.2549C22.8596 12.7341 21.6806 8.80747 19.3034 5.33716ZM8.5201 14.8459C7.48007 14.8459 6.63107 13.9014 6.63107 12.7447C6.63107 11.5879 7.45884 10.6434 8.5201 10.6434C9.57071 10.6434 10.4303 11.5879 10.4091 12.7447C10.4091 13.9014 9.57071 14.8459 8.5201 14.8459ZM15.4936 14.8459C14.4535 14.8459 13.6034 13.9014 13.6034 12.7447C13.6034 11.5879 14.4323 10.6434 15.4936 10.6434C16.5442 10.6434 17.4038 11.5879 17.3825 12.7447C17.3825 13.9014 16.5548 14.8459 15.4936 14.8459Z"></path></svg>',
    projectLink: false,
...
// Loop through all projects & programmatically add to the frontend
        ...
        <div class="flex flex-row gap-3 items-center justify-between lg:p-4 lg:border-[1.5px] lg:border-white/20 lg:rounded-md">
            <div class="flex flex-row justify-center items-center gap-2">
                ...
                <div class="flex flex-col">
                    <a href="${
                      projectLink ? projectLink : projectGithub
                    }" target="_blank" class="text-lg w-fit">${projectTitle}</a>
