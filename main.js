...
setTimeout(() => {
  document.addEventListener("mousemove", (e) => {
    ...
    asciiModelRotation = mapRange(x, -windowWidthHalf, windowWidthHalf, -maxThetaX, maxThetaX) - Math.PI / 4;
    // console.log(asciiModelRotation)
  });
}, 1500)
